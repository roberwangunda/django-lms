...
from .views import (
        ...
        validate_username, register, delete_librarian, 
        edit_librarian, librarian_add_view, LibrarianListView,
...
urlpatterns = [
    ...
    path('librarians/', LibrarianListView.as_view(), name='librarian_list'),
    path('lecturer/add/', staff_add_view, name='add_lecturer'),
    path('librarian/add/', librarian_add_view, name='add_librarian'),
    path('staff/<int:pk>/edit/', edit_staff, name='staff_edit'),
    path('librarian/<int:pk>/edit/', edit_librarian, name='librarian_edit'),
    path('lecturers/<int:pk>/delete/', delete_staff, name='lecturer_delete'),
    path('librarians/<int:pk>/delete/', delete_librarian, name='librarian_delete'),
