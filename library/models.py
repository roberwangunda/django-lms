...
# class BooksItem(models.Model):
#     invoice = models.ForeignKey(Books, on_delete=models.CASCADE)
...
class Borrow(models.Model):
    student = models.ForeignKey(Students, on_delete= models.CASCADE, related_name="student_fk")
    book = models.ForeignKey(Books, on_delete= models.CASCADE, related_name="book_fk")
...
# class BorrowProfile(models.Model) :
#     student = models.ForeignKey(Students,on_delete=models.CASCADE,related_name="student_fk")  
#     book = models.ForeignKey(Books, on_delete= models.CASCADE, related_name="book_fk")


#     class Meta:
#         verbose_name_plural = "Borred book by a student"
