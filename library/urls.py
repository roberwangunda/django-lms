...
from .views import BooksCreateView, StudentDetailView 
...
urlpatterns = [
    ...
    # path('borrow_profile/<int:pk>',views.view_borrow_profile,name='borrow_profile')
    path("student_detail", StudentDetailView.as_view(), name="student-detail"),
    path("student_detail/<int:pk>/", StudentDetailView.as_view(), name="student-detail-pk"),
