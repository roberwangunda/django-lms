...
from .models import Category, Books, Students, SubCategory
...
class BooksItemFormset (forms.ModelForm):
     isbn = forms.CharField(max_length=250)
     title = forms.CharField(max_length=250)
     category = forms.CharField(max_length=250)
     class Meta:
...
# BooksItemFormset = inlineformset_factory(
#     Books, SubCategory, fields=["isbn", "title", "category"], extra=8, can_delete=True
# )

# BooksReceiptFormSet = inlineformset_factory(
#     Invoice,
